...
namespace footballstats.Data.Migrations
{
    ...
    [Migration("20170115205257_player_goals")]
    partial class player_goals
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("footballstats.Models.DomainTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("footballstats.Models.Player", b =>
                {
                    ...
                    b.HasOne("footballstats.Models.Team")
                        .WithMany("AllPLayers")
