...
namespace footballstats.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Firstname,Lastname,Number,Role")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Firstname,Lastname,Number,Role")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
